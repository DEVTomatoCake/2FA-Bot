// Copied from https://github.com/Levminer/speakeasy/blob/main/main.js (MIT License)
...
exports.hotp.verifyDelta = hotpVerifyDelta = (options) => {
	...
	if (token.length !== digits) {
		throw new Error("@levminer/speakeasy - hotpVerifyDelta - Wrong token length: expected " + digits + ", got " + token.length)
	}
